                ...
                if __name__ == "__main__":
                    while True:
                        ...
                        if "wake up" in self.query:
                            ...
                            from pygame import mixer
                            mixer.init()
                            mixer.music.load("yt5s.io - Energetic Rock Guitar Backing Track E Minor (128 kbps) (mp3cut.net).mp3")
                            mixer.music.play()
                            ...
                            while True:
                                ...
                                #################### JARVIS: THe Trilogy 2.0 #####################
                                    ...
                                    pyautogui.press("super")
                                    pyautogui.sleep(2)
                                    pyautogui.typewrite("phone link")
                                    pyautogui.sleep(2)
                                    pyautogui.press("enter")
                                    pyautogui.sleep(2)
                                    pyautogui.click(1100, 200)
                                    pyautogui.sleep(2)
                                    pyautogui.typewrite(call)
                                ...
                                ############################################################
                                    ...
                                    b = random.choice(a)
                                    if b==1:
                                        webbrowser.open("https://youtu.be/Q8Bz8hI9meM")
                                ...
                                elif "hack my phone" in self.query:
                                    from women import play_gif1
                                    play_gif1
...
class Main (QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:\\Users\\HP\\OneDrive\\Desktop\\jarvis\\Jarvis_Final-20221202T081334Z-001\\Jarvis_Final\\ezgif.com-gif-maker (1).gif")
